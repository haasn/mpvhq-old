...
//---------------------- libao/libvo options ------------------------
    ...
    OPT_CHOICE("colormatrix-primaries", requested_primaries, 0,
               ({"auto", MP_CSP_PRIM_AUTO},
                ...
                {"AppleRGB", MP_CSP_PRIM_APPLE},
                {"AdobeRGB", MP_CSP_PRIM_ADOBE},
                {"ProPhotoRGB", MP_CSP_PRIM_PRO_PHOTO},
                {"CIE1931", MP_CSP_PRIM_CIE_1931})),
    OPT_CHOICE("colormatrix-gamma", requested_gamma, 0,
               ({"auto", MP_CSP_TRC_AUTO},
                ...
                {"ProPhotoRGB", MP_CSP_TRC_PRO_PHOTO})),
